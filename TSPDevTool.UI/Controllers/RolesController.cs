...
namespace TSPDevTool.UI.Controllers
{
    ...
    public class RolesController : Controller
    {
        ...
        {
            return View(roleBusinessManager.GetAll());
        }
        ...
        public ActionResult Details(int? id)
        {
            ...
            Role role = roleBusinessManager.GetById(id.Value);
            if (role == null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult Edit([Bind(Include = "ID,Name")] Role role)
        {
            if (ModelState.IsValid)
            {
                roleBusinessManager.Update(role);
            }
            return View(role);
        }
        ...
        {
            roleBusinessManager.Deletebyid(id);
            return RedirectToAction("Index");
        }
